...
export const AmbulanceDetailPage: React.FC = () => {
    ...
    return (
      <div className="space-y-4">
        ...
        <Card title="Dispatch Unavailable">
          <p className="text-sm text-red-600">{error || 'Dispatch not found.'}</p>
        </Card>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6 max-w-6xl mx-auto">
      ...
      <div className="p-3.5 bg-primary-50/75 border border-primary-200 rounded-xl flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="p-2 bg-primary-600 text-white rounded-lg">
            <FlaskConical className="w-5 h-5" />
          </div>
          <div>
            <span className="font-bold text-primary-950 text-xs block">
        ...
        <span className="text-[10px] font-mono uppercase bg-primary-200/70 text-primary-950 px-2 py-1 rounded font-bold">
          ETA_MODE=simulation
        </span>
      </div>
      ...
      {dispatch.emergency && (
        <div className="p-3.5 bg-red-50 border border-red-200 rounded-xl flex items-center justify-between">
          ...
          <span className="px-2.5 py-0.5 bg-red-200 text-red-950 font-bold text-[10px] rounded uppercase">
            Priority 1
          </span>
        </div>
      )}
        ...
        <div className="space-y-6 lg:col-span-2">
          ...
          <Card title="Transit Telemetry & Route Details">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
              ...
              <div className="p-4 bg-primary-50/50 rounded-xl border border-primary-200 space-y-1.5">
                <span className="text-[10px] font-bold uppercase tracking-wider text-primary-700 block">
                  Destination (Receiving Facility)
                </span>
                <h4 className="font-bold text-primary-950 flex items-center gap-1.5 text-sm">
                  <MapPin className="w-4 h-4 text-primary-600" />
                  {dispatch.destination_name}
                </h4>
                <span className="text-[11px] font-mono text-primary-700/80 block">
            ...
            <div className="mt-4 p-4 bg-slate-900 text-white rounded-xl grid grid-cols-2 sm:grid-cols-4 gap-4 text-xs">
              ...
              <div>
                ...
                <span className="text-base font-extrabold text-green-400 mt-0.5 flex items-center gap-1">
          ...
          <Card title="Patient Profile">
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 text-xs">
              ...
              <div className="p-3 bg-slate-50 rounded-lg border border-slate-100">
                ...
                <span className="font-bold text-primary-700 block mt-0.5 uppercase">
